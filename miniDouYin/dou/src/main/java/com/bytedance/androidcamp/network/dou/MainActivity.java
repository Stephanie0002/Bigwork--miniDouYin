...
public class MainActivity extends AppCompatActivity {
    ...
    private static final int fab_add = 1808;
    ...
    private void initBtns() {
        ...
        fab.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivityForResult(intent,fab_add);
            }
        });
        ...
        mBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (getString(R.string.select_an_image).equals(s)) {
                    //@TODO 1填充选择图片的功能
                    Toast.makeText(MainActivity.this,"为你的视频选择一个封面吧！",Toast.LENGTH_LONG)
                            .show();
    ...
    protected void onActivityResult(int requestCode, int resultCode, final Intent data) {
        ...
        if (resultCode == RESULT_OK && null != data) {
            if (requestCode == PICK_IMAGE) {
                ...
                mSelectedImage = data.getData();
                Log.d(TAG, "selectedImage = " + mSelectedImage);
                Toast.makeText(MainActivity.this,"上传中...",Toast.LENGTH_SHORT)
                        .show();
                postVideo();
            }
                ...
                new Callback<PostVideoResponse>() {
                    ...
                    public void onResponse(Call<PostVideoResponse> call, Response<PostVideoResponse> response) {
                        if (response.body() != null) {
                            Toast.makeText(MainActivity.this, "上传成功！" +  response.body().toString(), Toast.LENGTH_SHORT)
                                    .show();
                            mBtnRefresh.callOnClick();
                        }
                        mBtn.setText(R.string.select_an_image);
            ...
            public void onResponse(Call<GetVideosResponse> call, Response<GetVideosResponse> response) {
                if (response.body() != null && response.body().videos != null) {
                    ...
                    if(chooseVedio == 1){
                        ...
                        mVideos = tempVedio;
                        Toast.makeText(MainActivity.this, "上传人id：" + mVideos.get(0).studentId, Toast.LENGTH_SHORT).show();
                    }
